...
def run_feature(df, params=None):
    """
    Tarefa 04: Limpeza de Duplicadas e Formatador
    Aluno Responsável: Aluno 04
    """
    params = params or {}
    ...
    return {
        "title": "Tarefa 04 - Limpeza de Duplicadas e Formatador",
        "description": "Módulo desenvolvido por Aluno 04 focado em Limpeza de Duplicadas e Formatador.",
        "metrics": {
