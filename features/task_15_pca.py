...
def run_feature(df, params=None):
    """
    Tarefa 15: PCA (Componentes Principais)
    Aluno Responsável: Aluno 15
    """
    params = params or {}
    ...
    return {
        "title": "Tarefa 15 - PCA (Componentes Principais)",
        "description": "Módulo desenvolvido por Aluno 15 focado em PCA (Componentes Principais).",
        "metrics": {
