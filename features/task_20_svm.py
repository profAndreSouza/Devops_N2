...
def run_feature(df, params=None):
    """
    Tarefa 20: Support Vector Machine (SVM)
    Aluno Responsável: Aluno 20
    """
    params = params or {}
    ...
    return {
        "title": "Tarefa 20 - Support Vector Machine (SVM)",
        "description": "Módulo desenvolvido por Aluno 20 focado em Support Vector Machine (SVM).",
        "metrics": {
