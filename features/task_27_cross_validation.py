...
def run_feature(df, params=None):
    """
    Tarefa 27: Validação Cruzada & Learning Curve
    Aluno Responsável: Aluno 27
    """
    params = params or {}
    ...
    return {
        "title": "Tarefa 27 - Validação Cruzada & Learning Curve",
        "description": "Módulo desenvolvido por Aluno 27 focado em Validação Cruzada & Learning Curve.",
        "metrics": {
