...
def run_feature(df, params=None):
    """
    Tarefa 25: Ajuste de Regressão Polinomial
    Aluno Responsável: Aluno 25
    """
    params = params or {}
    ...
    return {
        "title": "Tarefa 25 - Ajuste de Regressão Polinomial",
        "description": "Módulo desenvolvido por Aluno 25 focado em Ajuste de Regressão Polinomial.",
        "metrics": {
