...
def run_feature(df, params=None):
    """
    Tarefa 13: Calculadora de Novas Features
    Aluno Responsável: Aluno 13
    """
    params = params or {}
    ...
    return {
        "title": "Tarefa 13 - Calculadora de Novas Features",
        "description": "Módulo desenvolvido por Aluno 13 focado em Calculadora de Novas Features.",
        "metrics": {
